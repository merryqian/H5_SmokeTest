...
public class DeliveryFeeRule {
    ...
    private double getBaseDeliveryFee(double weight,DeliveryFeeConfig deliveryFeeConfig){
        ...
        if(deliveryFeeConfig.getBaseWeight()<weight){
            baseFee += (weight-deliveryFeeConfig.getBaseWeight())

*deliveryFeeConfig.getBaseAdditionalWeight();
        }
    ...
    private DeliveryFeeConfig getDeliveryFeeConfig(){
        ...
        deliveryFeeConfig.setBaseFee(Double.parseDouble(PropertiesUtils.getProperty

(config,"base.fee")));
        deliveryFeeConfig.setBaseWeight(Double.parseDouble(PropertiesUtils.getProperty

(config,"base.weight")));
        deliveryFeeConfig.setBaseAdditionalWeight(Double.parseDouble(PropertiesUtils.getProperty

(config,"base.additional.weight")));

        deliveryFeeConfig.setDiscountPerFee(Double.parseDouble(PropertiesUtils.getProperty

(config,"discount.per.fee")));
        deliveryFeeConfig.setDiscountWeight(Double.parseDouble(PropertiesUtils.getProperty

(config,"discount.weight")));
        deliveryFeeConfig.setDiscountAdditionalWeight(Double.parseDouble(PropertiesUtils.getProperty

(config,"discount.additional.weight")));
